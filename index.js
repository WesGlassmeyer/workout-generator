...
function getArmExercises() {
 return fetch('https://wger.de/api/v2/exercise/?format=json&language=2&limit=100&category=8')
    .then(response => {
      if (response.ok) {
        return response.json();
      }
...
function getLegExercises() {
 return fetch('https://wger.de/api/v2/exercise/?format=json&language=2&limit=100&category=9')
    .then(response => {
      if (response.ok) {
        return response.json();
      }
...
function getAbsExercises() {
 return fetch('https://wger.de/api/v2/exercise/?format=json&language=2&limit=100&category=10')
    .then(response => {
      if (response.ok) {
        return response.json();
      }
...
function getChestExercises() {
 return fetch('https://wger.de/api/v2/exercise/?format=json&language=2&limit=100&category=11')
    .then(response => {
      if (response.ok) {
        return response.json();
      }
...
function getBackExercises() {
 return fetch('https://wger.de/api/v2/exercise/?format=json&language=2&limit=100&category=12')
    .then(response => {
      if (response.ok) {
        return response.json();
      }
...
function getShoulderExercises() {
 return fetch('https://wger.de/api/v2/exercise/?format=json&language=2&limit=100&category=13')
    .then(response => {
      if (response.ok) {
        return response.json();
      }
...
function getCalvesExercises() {
 return fetch('https://wger.de/api/v2/exercise/?format=json&language=2&limit100&category=14')
    .then(response => {
      if (response.ok) {
        return response.json();
      }
...
function getAllExercises() {
 return Promise.all([getArmExercises(), getLegExercises(), getAbsExercises(), getChestExercises(), getBackExercises(), getShoulderExercises(), getCalvesExercises()])
 .then(responses => { 
...
function getRandomNumber() {
  for (let i = 0; i < responseLength.length; i++) {
    randomExerciseNumber.push(Math.floor(Math.random() * (responseLength[i] - 1 )))
  }
}
